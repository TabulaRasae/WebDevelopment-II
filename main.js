...
app.post ("/ageInMonthsOnly", (req,res) =>
{
    ...
    if (
        isNaN(birthY) || isNaN(birthM) ||
        isNaN(currentY) || isNaN(currentM)
    ) {
...
app.post ("/ageInYearsOnly", (req,res) =>
{
    ...
    const ageInYearsOnly = Math.floor((((currentY*12)+currentM) - ((birthY*12)+birthM)) / 12);
...
app.post ("/ageInYearsAndMonths", (req,res) =>
{
    ...
    const years = parseInt((((currentY*12)+currentM) - ((birthY*12)+birthM)) / 12);
